...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference('Water.count') do
      post waters_url, params: { water: { amount: @water.amount, time: @water.time, title: @water.title, unit: @water.unit } }
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { amount: @water.amount, time: @water.time, title: @water.title, unit: @water.unit } }
